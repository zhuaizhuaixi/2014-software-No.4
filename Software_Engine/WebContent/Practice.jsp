...
<!--留言板-->
    ...
    <td valign="top" ><table width="100%" height="31" border="0" cellpadding="0" cellspacing="0" class="left_topbg" id="table2" style="background-image:url(picture/content-bg.gif)">
      <tbody><tr>
        ...
        <td height="31" width="130"><div class="titlebt"><a href="practice.action"><font color="#00AEAE">习题问答</a></div></td>
...
<a href="addpractice.jsp" class="button grey">导入习题</a>
 	<table>
		...
		<tr>
			...
			<td> <a	href="deletepractice.action?deleteid=<%=student.getId()%>">删除</a></td>
		</tr>
