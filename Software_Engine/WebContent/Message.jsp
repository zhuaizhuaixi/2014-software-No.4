...
<!--留言板-->
    ...
    <td valign="top" ><table width="100%" height="31" border="0" cellpadding="0" cellspacing="0" class="left_topbg" id="table2" style="background-image:url(picture/content-bg.gif)">
      <tbody><tr>
        ...
        <td height="31" width="130" ><div class="titlebt" ><a href="showmessage.action"><font color="#00AEAE">交流天地</a></div></td>
    ...
    <form action="submitmessage.action?msgerid=${sessionScope.value}" method="post">
