...
<!--留言板-->
    ...
    <td valign="top" ><table width="100%" height="31" border="0" cellpadding="0" cellspacing="0" class="left_topbg" id="table2" style="background-image:url(picture/content-bg.gif)">
      <tbody><tr>
        ...
        <td height="31" width="130"><div class="titlebt">教学大纲</div></td>
        <td height="31" width="130"><div class="titlebt">习题问答</div></td>
        <td height="31" width="130" ><div class="titlebt" >教学实验</div></td>
    ...
    <!--按钮-->
    	...
    	<a href="#" class="button grey">导入数据</a>
		 <!--正文-->
		</div>
